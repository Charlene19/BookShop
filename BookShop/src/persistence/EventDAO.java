...
public class EventDAO implements CrudOperation<Event> {
    ...
    @Override
    public Event findObject(Object id) {
    ...
    @Override
    public void createObject(Event object) {
    ...
    @Override
    public void deleteObject(Event object) {
